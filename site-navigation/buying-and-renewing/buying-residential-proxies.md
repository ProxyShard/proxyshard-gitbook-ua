...
<figure>
  <picture>
    ...
    <img src="../../.gitbook/assets/residential-invoice-payment_white.png" alt="Оплата резидентських проксі з балансу">
  </picture>
</figure>

Після оплати відкриється панель налаштування та генерації проксі. Опис параметрів замовлення доступний у [розділі про резидентські проксі](../../our-products/residential-proxies/#nalashtuvannya-proksi).
...
<figure>
  <picture>
    ...
    <img src="../../.gitbook/assets/residential-add-traffic_white.png" alt="Додавання трафіку до замовлення">
  </picture>
</figure>
