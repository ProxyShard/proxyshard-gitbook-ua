...
Стандартне блокування <mark style="color:purple;">Gatekeeper</mark>. Дотримуйтесь кроків у розділі [Зняття блокування Gatekeeper](#зняття-блокування-gatekeeper) — там описані обидва способи відкрити Термінал і команда для зняття карантину.
