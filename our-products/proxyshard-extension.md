---
description: Розширення для Chrome та інших браузерів на рушії Chromium
icon: puzzle-piece
---

# ProxyShard Extension

<mark style="color:purple;">**ProxyShard – Smart Proxy Manager**</mark> - це наше фірмове розширення для браузерів на рушії Chromium (<mark style="color:purple;">Chrome</mark>, <mark style="color:purple;">Edge</mark>, <mark style="color:purple;">Opera</mark>, <mark style="color:purple;">Brave</mark>, <mark style="color:purple;">Yandex</mark> та інших), яке дозволяє в пару кліків додавати, перемикати та тестувати проксі прямо з браузера, без сторонніх програм.

#### Що вміє розширення:

* Зберігає необмежену кількість профілів проксі
* Підтримує <mark style="color:purple;">HTTP / HTTPS</mark> та <mark style="color:purple;">SOCKS5</mark> (без авторизації) з'єднання
...
<div align="center"><figure><img src="../.gitbook/assets/ext-promo.png" alt="Вигляд розширення ProxyShard"><figcaption><p>Вигляд розширення ProxyShard</p></figcaption></figure></div>

## Встановлення розширення

Розширення доступне в офіційному **Chrome Web Store**, воно також без проблем встановлюється в Edge, Opera, Brave та інші Chromium-браузери.
...
<div align="center"><figure><img src="../.gitbook/assets/ext-resiadd2.png" alt="Додавання проксі в розширення"><figcaption><p>Крок 5: вставка проксі та додавання профілю</p></figcaption></figure></div>
...
<div align="center"><figure><img src="../.gitbook/assets/ext-resiadd4.png" alt="Активація проксі в розширенні"><figcaption><p>Крок 6: тестування та запуск профілю</p></figcaption></figure></div>
...
<div align="center"><figure><img src="../.gitbook/assets/ext-dcispadd2.png" alt="Вставка проксі в розширення"><figcaption><p>Крок 3: вставка проксі в розширення</p></figcaption></figure></div>
...
<div align="center"><figure><img src="../.gitbook/assets/ext-dcispadd3.png" alt="Активація профілю DC/ISP"><figcaption><p>Крок 4: тестування та запуск профілю</p></figcaption></figure></div>
...
<div align="center"><figure><img src="../.gitbook/assets/ext-iprotate.png" alt="Налаштування IP Rotation"><figcaption><p>Блок IP Rotation у налаштуваннях профілю</p></figcaption></figure></div>
{% endhint %}
...
{% hint style="success" %}
**Готово!** Розширення ProxyShard повністю налаштоване і готове до роботи. Перемикайтеся між проксі «в один клік» з будь-якого браузера на Chromium.
{% endhint %}
