...
{% hint style="success" %}
**Google-акаунти:** разом із розробником [Vision Browser](../setup-guides/antidetect-browsers/vision-browser.md) ми перевірили реєстрацію Google без модифікації відбитка браузера. На чистому профілі без заміни p0f система відразу потребує верифікації за номером телефону. З заміною p0f на Windows 10/11 Google пропонує верифікацію через QR-код, що підтверджує відсутність детекту проксі.
{% endhint %}
