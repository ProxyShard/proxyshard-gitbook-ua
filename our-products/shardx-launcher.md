...
# ShardX Browser (антидетект-браузер)

<mark style="color:purple;">**ShardX Browser**</mark> — це наш антидетект-браузер: ви створюєте окремі профілі з унікальними відбитками (fingerprint), прив'язуєте до кожного свій проксі та працюєте з десятками акаунтів так, ніби це різні люди на різних пристроях. Поверх ручного режиму є локальне **API автоматизації**, через яке профілі можна створювати, запускати та керувати ними роботом із Puppeteer / Playwright.
...
{% hint style="success" %}
Зв'язка ShardX + наші [**проксі з UDP**](udp-proxies.md) закриває витік WebRTC на рівні браузера: UDP-трафік іде через проксі, а не напряму з вашого IP. Детальніше про саму проблему — у розділі [**Про протокол UDP**](about-udp/).
{% endhint %}
