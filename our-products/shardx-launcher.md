...
# ShardX Launcher (антидетект-браузер)

<mark style="color:purple;">**ShardX Launcher**</mark> — це наш антидетект-браузер: ви створюєте окремі профілі з унікальними відбитками (fingerprint), прив'язуєте до кожного свій проксі та працюєте з десятками акаунтів так, ніби це різні люди на різних пристроях. Поверх ручного режиму є локальне **API автоматизації**, через яке профілі можна створювати, запускати та керувати ними роботом із Puppeteer / Playwright.
