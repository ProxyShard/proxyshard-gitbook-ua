...
<mark style="color:purple;">**ShardX Browser**</mark> - це наш антидетект-браузер. Створюйте окремі профілі з унікальними відбитками (fingerprint), призначайте кожному профілю окремий проксі та працюйте з десятками акаунтів як різні користувачі на різних пристроях. Локальне **API автоматизації** також дає змогу створювати, запускати профілі та керувати ними через Puppeteer / Playwright.

## Завантажити та встановити

<mark style="color:violet;">**Покрокова інструкція зі встановлення, налаштування проксі та створення першого профілю:**</mark>
